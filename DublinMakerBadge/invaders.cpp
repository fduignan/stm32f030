...
#define MAX_ATTACKER_MISSILES (MAX_INVADERS)
  ...
  Console.print("MCU Galaga", 10, 10, 40, RGBToWord(0xff, 0xff, 0xff), RGBToWord(0, 0, 0));
  Console.print("Only 5 missiles", 15, 10, 60, RGBToWord(0xff, 0xff, 0xff), RGBToWord(0, 0, 0));
  Console.print("can be in flight", 16, 10, 80, RGBToWord(0xff, 0xff, 0xff), RGBToWord(0, 0, 0));
  Console.print("at one time", 11, 10, 100, RGBToWord(0xff, 0xff, 0xff), RGBToWord(0, 0, 0));
  ...
  while (Level > 0)
  {
    ...
    Console.print(MAX_INVADER_LEVELS - Level + 1, 60, SCREEN_HEIGHT-10, RGBToWord(0xff, 0xff, 0xff), RGBToWord(0, 0, 0));    
    ...
    while (!LevelComplete )
    {
      ...
      Console.Timer.sleep(15);  // slow the game to make it playable
